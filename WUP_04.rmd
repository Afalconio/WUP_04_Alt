...
We have changed all of the character variables into factor variables, and we see that our problem takes a numerical variable, WORDSUM, and explains it with a factor variable with three levels called RACE. A helper file can bed used to complete the analysis of the factor and numerical variables.
